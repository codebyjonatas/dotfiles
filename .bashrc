...
export OSH='/home/jonatas/.oh-my-bash'
...
# VS Code (WSL)
export PATH="$PATH:/mnt/c/Users/JONATAS/AppData/Local/Programs/Microsoft VS Code/bin"
...
eval "$(starship init bash)" # ou zsh, fish etc.
